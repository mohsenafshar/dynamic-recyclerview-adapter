...
public class HeaderEmployeeViewHolder extends BaseViewHolder<Employee> {

    private static final String TAG = HeaderEmployeeViewHolder.class.getSimpleName();
    ...
    HeaderEmployeeViewHolder(@NonNull View itemView) {
        super(itemView);
